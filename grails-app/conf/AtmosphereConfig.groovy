atmospherePlugin {
    servlet {
        ...
        initParams = ['org.atmosphere.cpr.sessionSupport': 'false',
    ...
    handlers {
        ...
        atmosphereDotXml = {
            'atmosphere-handler'('context-root': '/atmosphere/callback', 'class-name': 'facebookstream.CallbackHandlerAtmosphereHandler')
        }
    }
}